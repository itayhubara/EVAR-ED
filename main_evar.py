...
def main():
    ...
    for epoch in range(args.start_epoch, args.epochs):
        ...
        # train for one epoch
        train_loss,train_top1,auc_train= train(
            train_loader, model, criterion, epoch, optimizer)

        # evaluate on validation set
        val_loss,val_top1,auc_val = validate(
        ...
        logging.info('\n Epoch: {0}\t'
                     ...
                     .format(epoch + 1, train_loss=train_loss, train_top1=train_top1,val_loss=val_loss,val_top1=val_top1))
...
def forward(data_loader, model, criterion, epoch=0, training=True, optimizer=None):
    ...
    return losses.avg, top1.avg,auc_meter.value()
